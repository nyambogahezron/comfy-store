...
import type { attachCookieProps } from "../types";
...
export default function attachCookieToResponse({ res, token, user }: attachCookieProps) {
	if (!res.cookie) {
		throw new InternalServerError('cookieParser("secret") required for signed cookies');
	}
