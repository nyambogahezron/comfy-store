			...
			<Card className="w-full max-w-[80%] p-8">
				...
				<div className="mb-8">
					...
					<div className="flex justify-between mt-2 text-sm">
						<span className={currentStep === "personal" ? "text-primary" : "text-muted-foreground"}>
							Personal
						</span>
						<span
							className={currentStep === "organization" ? "text-primary" : "text-muted-foreground"}
						>
							Organization
						</span>
						<span
							className={currentStep === "verification" ? "text-primary" : "text-muted-foreground"}
						>
							Verify
						</span>
					</div>
