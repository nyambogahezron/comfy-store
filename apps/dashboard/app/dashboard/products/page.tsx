			...
			<div className="space-y-6">
							...
							<TableBody>
								{products.map((product) => (
									<TableRow key={product.id} className="cursor-pointer">
										<TableCell className="font-medium" onClick={() => handleRowClick(product)}>
								...
								<div className="space-y-4">
									...
									<div>
										...
										<Input
											...
											step="0.01"
											min="0"
											defaultValue={isEditMode && selectedProduct ? selectedProduct.price : ""}
										/>
									</div>
									<div>
										...
										<Input
											...
											placeholder="100"
											min="0"
											defaultValue={isEditMode && selectedProduct ? selectedProduct.stock : ""}
										/>
									</div>
									<div>
										...
										<Textarea
											...
											defaultValue={
												isEditMode && selectedProduct ? selectedProduct.description : ""
											}
										/>
									</div>
									<div>
										...
										<Input
											...
											defaultValue={isEditMode && selectedProduct ? selectedProduct.image : ""}
										/>
									</div>
								</div>
							</form>
				...
				<Toast open={isDeleteToastOpen} onOpenChange={setIsDeleteToastOpen}>
					...
					<div className="flex space-x-2">
						<Button variant="outline" onClick={() => setIsDeleteToastOpen(false)}>
							Cancel
						</Button>
