...
type SignedCookieFunction = (str: string, secret: string | string[]) => string | false | undefined;

const signedCookie: SignedCookieFunction = (str, secret) => {
...
type SignedCookiesFunction = (obj: CookieObject, secret: string | string[]) => CookieObject;

const signedCookies: SignedCookiesFunction = (obj, secret) => {
	var cookies = Object.keys(obj);
